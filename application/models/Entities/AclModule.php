...
class Model_Entities_AclModule
{

    /**
     * @var Model_Entities_Mapper_AclModuleMapper
     */
     ...
     * @var varchar
     */
    protected $_acl_module_name = null;
    ...
    public function getMapper()
    {
        if (null === $this->_mapper){
        	$this->setMapper ( new Model_Entities_Mapper_AclModuleMapper ( ) );
        }
        return $this->_mapper;
    }
    ...
    /**
     * Set the _acl_module_name property
     * 
     * @param string $value
     * @return mixed
     */
    public function setAclModuleName($value = null)
    {
        $this->_acl_module_name = $value;
        return $this;
    }

    /**
     * Retrieve the _acl_module_name property
     * 
     * @return string|null
     */
    public function getAclModuleName()
    {
        return $this->_acl_module_name;
    }
    ...
    {
        return $this->getMapper ()->save ( $this, $filter_array, true, 'acl_module_id' );
    }
