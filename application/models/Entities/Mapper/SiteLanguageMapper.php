...
class Model_Entities_Mapper_SiteLanguageMapper
{

    /**
     * @var Model_Entities_DbTable_SiteLanguage
     */
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable){
        	$this->setDbTable ( 'Model_Entities_DbTable_SiteLanguage' );
        }
     ...
     * @return Model_Entities_Mapper_SiteLanguageMapper
     */
    ...
    /**
     * Save a SiteLanguage entry
     * 
     * @param Model_Entities_SiteLanguage $object
     * @return void
     */
    public function save(Model_Entities_SiteLanguage $object, Array $filter_array = array(), $ignoreEmptyValuesOnUpdate = true, $pkey = 'id')
    {
        $data = array (
        	'id' => $object->getId(),
        	'role_id' => $object->getRoleId(),
        	'lang_key' => $object->getLangKey(),
        	'translated' => $object->getTranslated(),
        	'translated_date' => $object->getTranslatedDate(),
     ...
     * @return array
     */
    public function toArray(Model_Entities_SiteLanguage $object)
    {
        return array (
        	'id' => $object->getId(),
        	'role_id' => $object->getRoleId(),
     ...
     * @return array
     */
    public function find($key, Model_Entities_SiteLanguage $object)
    {
        ...
        $object->setId($dtr->id)
        	...
        	->setTranslated($dtr->translated)
        	->setTranslatedDate($dtr->translated_date)
        	->setDefault($dtr->default)
    ...
    public function search($column, $keyword)
    {
        ...
        foreach ( $dts as $key => $dtr ){
        	$object = new Model_Entities_SiteLanguage ( );
        	$object->setId($dtr->id)
        		->setRoleId($dtr->role_id)
        		->setLangKey($dtr->lang_key)
        		->setTranslated($dtr->translated)
