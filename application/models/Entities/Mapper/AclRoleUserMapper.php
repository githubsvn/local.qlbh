...
class Model_Entities_Mapper_AclRoleUserMapper
{

    /**
     * @var Model_Entities_DbTable_AclRoleUser
     */
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable){
        	$this->setDbTable ( 'Model_Entities_DbTable_AclRoleUser' );
        }
     ...
     * @return Model_Entities_Mapper_AclRoleUserMapper
     */
    ...
    /**
     * Save a AclRoleUser entry
     * 
     * @param Model_Entities_AclRoleUser $object
     * @return void
     */
    public function save(Model_Entities_AclRoleUser $object, Array $filter_array = array(), $ignoreEmptyValuesOnUpdate = true, $pkey = 'id')
    {
        $data = array (
        	'id' => $object->getId(),
     ...
     * @return array
     */
    public function toArray(Model_Entities_AclRoleUser $object)
    {
        return array (
        	'id' => $object->getId(),
        	'user_id' => $object->getUserId(),
     ...
     * @return array
     */
    public function find($key, Model_Entities_AclRoleUser $object)
    {
    ...
    public function search($column, $keyword)
    {
        ...
        foreach ( $dts as $key => $dtr ){
        	$object = new Model_Entities_AclRoleUser ( );
        	$object->setId($dtr->id)
        		->setUserId($dtr->user_id)
        		->setAclRoleId($dtr->acl_role_id)
        		->setStatus($dtr->status)
