...
class Model_Entities_Mapper_CountryMapper
{

    /**
     * @var Model_Entities_DbTable_Country
     */
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable){
        	$this->setDbTable ( 'Model_Entities_DbTable_Country' );
        }
     ...
     * @return Model_Entities_Mapper_CountryMapper
     */
    ...
    /**
     * Save a Country entry
     * 
     * @param Model_Entities_Country $object
     * @return void
     */
    public function save(Model_Entities_Country $object, Array $filter_array = array(), $ignoreEmptyValuesOnUpdate = true, $pkey = 'id')
    {
        $data = array (
        	'id' => $object->getId(),
        	'key' => $object->getKey(),
     ...
     * @return array
     */
    public function toArray(Model_Entities_Country $object)
    {
        return array (
        	'id' => $object->getId(),
        	'key' => $object->getKey(),
     ...
     * @return array
     */
    public function find($key, Model_Entities_Country $object)
    {
    ...
    public function search($column, $keyword)
    {
        ...
        foreach ( $dts as $key => $dtr ){
        	$object = new Model_Entities_Country ( );
        	$object->setId($dtr->id)
        		->setKey($dtr->key)
        		->setName($dtr->name)
        		->setNameCap($dtr->name_cap)
