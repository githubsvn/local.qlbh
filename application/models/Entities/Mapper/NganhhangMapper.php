...
class Model_Entities_Mapper_NganhhangMapper
{

    /**
     * @var Model_Entities_DbTable_Nganhhang
     */
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable){
        	$this->setDbTable ( 'Model_Entities_DbTable_Nganhhang' );
        }
     ...
     * @return Model_Entities_Mapper_NganhhangMapper
     */
    ...
    /**
     * Save a Nganhhang entry
     * 
     * @param Model_Entities_Nganhhang $object
     * @return void
     */
    public function save(Model_Entities_Nganhhang $object, Array $filter_array = array(), $ignoreEmptyValuesOnUpdate = true, $pkey = 'id')
    {
        $data = array (
        	'id' => $object->getId(),
        	'ten' => $object->getTen()
     ...
     * @return array
     */
    public function toArray(Model_Entities_Nganhhang $object)
    {
        return array (
        	'id' => $object->getId(),
        	'ten' => $object->getTen()
     ...
     * @return array
     */
    public function find($key, Model_Entities_Nganhhang $object)
    {
    ...
    public function search($column, $keyword)
    {
        ...
        foreach ( $dts as $key => $dtr ){
        	$object = new Model_Entities_Nganhhang ( );
        	$object->setId($dtr->id)
        		->setTen($dtr->ten)
        		->setMapper ( $this );
