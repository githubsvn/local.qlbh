...
class Model_Entities_Mapper_NccMapper
{

    /**
     * @var Model_Entities_DbTable_Ncc
     */
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable){
        	$this->setDbTable ( 'Model_Entities_DbTable_Ncc' );
        }
     ...
     * @return Model_Entities_Mapper_NccMapper
     */
     ...
     * Save a Ncc entry
     * 
     * @param Model_Entities_Ncc $object
     * @return void
     */
    public function save(Model_Entities_Ncc $object, Array $filter_array = array(), $ignoreEmptyValuesOnUpdate = true, $pkey = 'id')
    {
        $data = array (
        	'id' => $object->getId(),
        	'ten' => $object->getTen(),
        	...
        	'dienthoai' => $object->getDienthoai(),
        	'fax' => $object->getFax(),
        	'tk_ten' => $object->getTkTen(),
        	'tk_sotk' => $object->getTkSotk(),
        	'tk_nganhang' => $object->getTkNganhang(),
        	'tk_diachi_nganhang' => $object->getTkDiachiNganhang()
        );
     ...
     * @return array
     */
    public function toArray(Model_Entities_Ncc $object)
    {
        return array (
        	'id' => $object->getId(),
        	'ten' => $object->getTen(),
     ...
     * @return array
     */
    public function find($key, Model_Entities_Ncc $object)
    {
        ...
        $object->setId($dtr->id)
        	->setTen($dtr->ten)
        	->setMst($dtr->mst)
        	->setDiachi($dtr->diachi)
        	->setDienthoai($dtr->dienthoai)
        	->setFax($dtr->fax)
        	->setTkTen($dtr->tk_ten)
        	->setTkSotk($dtr->tk_sotk)
        	->setTkNganhang($dtr->tk_nganhang)
        	->setTkDiachiNganhang($dtr->tk_diachi_nganhang)
        	->setMapper ( $this );
    }
