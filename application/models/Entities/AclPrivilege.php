...
class Model_Entities_AclPrivilege
{

    /**
     * @var Model_Entities_Mapper_AclPrivilegeMapper
     */
     ...
     * @var varchar
     */
    protected $_acl_privilege_name = null;
    ...
    public function getMapper()
    {
        if (null === $this->_mapper){
        	$this->setMapper ( new Model_Entities_Mapper_AclPrivilegeMapper ( ) );
        }
        return $this->_mapper;
    }
    ...
    /**
     * Set the _acl_privilege_name property
     * 
     * @param string $value
     * @return mixed
     */
    public function setAclPrivilegeName($value = null)
    {
        $this->_acl_privilege_name = $value;
        return $this;
    }

    /**
     * Retrieve the _acl_privilege_name property
     * 
     * @return string|null
     */
    public function getAclPrivilegeName()
    {
        return $this->_acl_privilege_name;
    }
    ...
    {
        return $this->getMapper ()->save ( $this, $filter_array, true, 'acl_privilege_id' );
    }
