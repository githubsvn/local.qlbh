...
class Model_Entities_SiteLanguage
{

    /**
     * @var Model_Entities_Mapper_SiteLanguageMapper
     */
     ...
     * @var varchar
     */
    protected $_translated = null;

    /**
     * @var datetime
     */
    protected $_translated_date = null;
    ...
    public function getMapper()
    {
        if (null === $this->_mapper){
        	$this->setMapper ( new Model_Entities_Mapper_SiteLanguageMapper ( ) );
        }
        return $this->_mapper;
    }
    ...
    /**
     * Set the _lang_key property
     * 
     * @param string $value
     * @return mixed
     */
    public function setLangKey($value = null)
    {
    ...
    /**
     * Retrieve the _lang_key property
     * 
     * @return string|null
     */
    ...
    /**
     * Set the _translated property
     * 
     * @param string $value
     * @return mixed
     */
    public function setTranslated($value = null)
    {
    ...
    /**
     * Retrieve the _translated property
     * 
     * @return string|null
     */
    ...
    /**
     * Set the _translated_date property
     * 
     * @param string $value
     * @return mixed
     */
    public function setTranslatedDate($value = null)
    {
        $this->_translated_date = $value;
        return $this;
    }

    /**
     * Retrieve the _translated_date property
     * 
     * @return string|null
     */
    public function getTranslatedDate()
    {
        return $this->_translated_date;
    }

    /**
     * Set the _default property
     * 
     * @param string $value
     * @return mixed
     */
    ...
    /**
     * Retrieve the _default property
     * 
     * @return string|null
     */
