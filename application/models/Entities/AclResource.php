...
class Model_Entities_AclResource
{

    /**
     * @var Model_Entities_Mapper_AclResourceMapper
     */
     ...
     * @var int
     */
    protected $_acl_resource_id = null;

    /**
     * @var int
     */
    protected $_acl_module_id = null;

    /**
     * @var varchar
     */
    protected $_acl_resource_name = null;
    ...
    public function getMapper()
    {
        if (null === $this->_mapper){
        	$this->setMapper ( new Model_Entities_Mapper_AclResourceMapper ( ) );
        }
        return $this->_mapper;
    }
    ...
    /**
     * Set the _acl_resource_id property
     * 
     * @param int $value
     * @return mixed
     */
    public function setAclResourceId($value = null)
    {
        $this->_acl_resource_id = $value;
        return $this;
    }

    /**
     * Retrieve the _acl_resource_id property
     * 
     * @return int|null
     */
    public function getAclResourceId()
    {
        return $this->_acl_resource_id;
    }

    /**
     * Set the _acl_module_id property
     * 
     * @param int $value
     * @return mixed
     */
    public function setAclModuleId($value = null)
    {
        $this->_acl_module_id = $value;
        return $this;
    }

    /**
     * Retrieve the _acl_module_id property
     * 
     * @return int|null
     */
    public function getAclModuleId()
    {
        return $this->_acl_module_id;
    }

    /**
     * Set the _acl_resource_name property
     * 
     * @param string $value
     * @return mixed
     */
    public function setAclResourceName($value = null)
    {
        $this->_acl_resource_name = $value;
        return $this;
    }

    /**
     * Retrieve the _acl_resource_name property
     * 
     * @return string|null
     */
    public function getAclResourceName()
    {
        return $this->_acl_resource_name;
    }
    ...
    {
        return $this->getMapper ()->save ( $this, $filter_array, true, 'acl_resource_id' );
    }
