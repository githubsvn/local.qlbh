...
class Model_Entities_DbTable_AclRolePrivilege extends Zend_Db_Table_Abstract
{

    protected $_name = 'mtx_acl_role_privilege';

    protected $_primary = 'acl_roleprivilege_id';
