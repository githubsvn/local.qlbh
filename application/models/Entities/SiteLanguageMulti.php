...
class Model_Entities_SiteLanguageMulti
{

    /**
     * @var Model_Entities_Mapper_SiteLanguageMultiMapper
     */
     ...
     * @var int
     */
    protected $_language_default_id = null;
    ...
    public function getMapper()
    {
        if (null === $this->_mapper){
        	$this->setMapper ( new Model_Entities_Mapper_SiteLanguageMultiMapper ( ) );
        }
        return $this->_mapper;
    }
    ...
    /**
     * Set the _language_default_id property
     * 
     * @param int $value
     * @return mixed
     */
    public function setLanguageDefaultId($value = null)
    {
        $this->_language_default_id = $value;
        return $this;
    }

    /**
     * Retrieve the _language_default_id property
     * 
     * @return int|null
     */
    public function getLanguageDefaultId()
    {
    ...
    /**
     * Set the _translate_text property
     * 
     * @param string $value
     * @return mixed
     */
    public function setTranslateText($value = null)
    {
        $this->_translate_text = $value;
        return $this;
    }

    /**
     * Retrieve the _translate_text property
     * 
     * @return string|null
     */
