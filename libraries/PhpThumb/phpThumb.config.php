...
$PHPTHUMB_CONFIG['document_root'] = $config->base_dir;
...
$PHPTHUMB_CONFIG['cache_directory']   = $config->cache_dir;
...
$PHPTHUMB_CONFIG['cache_source_directory'] =$config->cache . '/source/';  // set the cache directory for unprocessed source images
...
function phpThumbURL($ParameterString) {
	...
	return 'phpThumb/phpThumb.php?'.$ParameterString.'&hash='.md5($ParameterString.@$PHPTHUMB_CONFIG['high_security_password']);
}
